                    ...
                    return `
                        <div class="d-flex flex-column">
                            ...
                            <div class="small text-muted">
                                ...
                                <i class="fas fa-arrow-right mx-1 text-xs"></i> ${end}
                            </div>
                        </div>`;
                }
            },
            // Col 2: Days
            { "data": "days_count", "className": "fw-bold text-center text-gray-700" },
            // Col 3: Status
            {
                "data": "status",
                "className": "text-center",
                "render": function(data) {
                    if(data == 0) return '<span class="badge bg-soft-warning text-warning border border-warning px-3 shadow-sm rounded-pill"><i class="fas fa-clock me-1"></i> Pending</span>';
                    if(data == 1) return '<span class="badge bg-soft-success text-success border border-success px-3 shadow-sm rounded-pill"><i class="fas fa-check me-1"></i> Approved</span>';
                    return '<span class="badge bg-soft-danger text-danger border border-danger px-3 shadow-sm rounded-pill"><i class="fas fa-times me-1"></i> Rejected</span>';
                }
            },
            // Col 4: Actions
            {
...
function viewDetails(id) {
    ...
    footer.find('.btn-action').remove(); // Remove old buttons
                ...
                let html = `
                    <div class="row">
                        <div class="col-md-5 text-center border-end">
                            <img src="../assets/images/${d.photo || 'default.png'}" class="rounded-circle border shadow-sm mb-3" style="width: 100px; height: 100px; object-fit: cover;">
