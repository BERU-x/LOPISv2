<?php
// ca_management.php (Admin/Manager Portal)
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="caTable" width="100%" cellspacing="0">
...
<div class="modal fade" id="viewCAModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6">
                        <label class="text-xs fw-bold text-uppercase text-gray-500">Date Requested</label>
                        <div id="modal_date_req" class="fw-bold text-dark"></div>
                    </div>
                    <div class="col-6">
                ...
                <div class="bg-light p-3 rounded mb-3">
                    <label class="text-xs fw-bold text-uppercase text-gray-500">Purpose / Remarks</label>
                    <p id="modal_remarks" class="mb-0 text-dark small fst-italic"></p>
                </div>

                <div class="row g-3 align-items-center border-top pt-3">
                    <div class="col-6 text-center border-end">
                        <label class="text-xs fw-bold text-uppercase text-gray-500 d-block">Requested Amount</label>
                        <span id="modal_req_amount" class="fw-bold text-teal h5">0.00</span>
                    </div>
                    <div class="col-6">
                         <label class="text-xs fw-bold text-uppercase text-gray-500 d-block">Approved Amount</label>
                        <input type="number" id="modal_approved_input" class="form-control form-control-sm text-center fw-bold" step="0.01">
            ...
            <div class="modal-footer bg-light" id="modal_actions">
                ...
                <button type="button" class="btn btn-danger" onclick="processCA('reject')">Reject</button>
                <button type="button" class="btn btn-success fw-bold" onclick="processCA('approve')">Approve</button>
            </div>
        </div>
    </div>
</div>
