...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex flex-column align-items-center justify-content-center py-4" 
       href="<?php echo $base_link; ?>dashboard.php" style="text-decoration: none;">
        <div class="sidebar-brand-icon">
            <img src="<?php echo $project_root; ?>/assets/images/LOPISv2.png" class="logo-large" alt="Full Logo" style="max-height: 100px;">
            <img src="<?php echo $project_root; ?>/assets/images/lendell_logo.png" class="logo-small" alt="Icon Logo" style="display:none;">
        </div>
    </a>
    ...
    <?php if ($user_type == 0): ?>
        ...
        <li class="nav-item <?php echo isActive('dashboard', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>dashboard.php">
        ...
        <li class="nav-item <?php echo isActive('admin_management', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>admin_management.php">
        ...
        <li class="nav-item <?php echo isActive('employee_management', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>employee_management.php">
        ...
        <div class="sidebar-heading">Payroll Configuration</div>

        <li class="nav-item <?php echo isActive('pay_components', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>pay_components.php">
        ...
        <li class="nav-item <?php echo isActive('tax_settings', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>tax_settings.php">
        ...
        <div class="sidebar-heading">Company Settings</div>

        <li class="nav-item <?php echo isActive('company_details', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>company_details.php">
        ...
        <li class="nav-item <?php echo isActive('financial_settings', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>financial_settings.php">
        ...
        <li class="nav-item <?php echo isActive('policy_settings', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>policy_settings.php">
        ...
        <li class="nav-item <?php echo isActive('general_settings', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>general_settings.php">
        ...
        <li class="nav-item <?php echo isActive('security_settings', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>security_settings.php">
        ...
        <li class="nav-item <?php echo isActive('audit_logs', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>audit_logs.php">
        ...
        <li class="nav-item <?php echo isActive('payroll_reports', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Payroll Reports">
        ...
        <li class="nav-item <?php echo isActive('tax_reports', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Tax Reports">
    ...
    <?php if ($user_type == 1): ?>
        ...
        <li class="nav-item <?php echo isActive('today_attendance', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>today_attendance.php">
        ...
        <li class="nav-item <?php echo isActive('financial_management', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>financial_management.php">
        ...
        <li class="nav-item <?php echo isActive('attendance_logs', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>attendance_logs.php">
        ...
        <li class="nav-item <?php echo isActive('leave_management', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>leave_management.php">
        ...
        <li class="nav-item <?php echo isActive('overtime_management', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>overtime_management.php">
        ...
        <li class="nav-item <?php echo isActive('ca_management', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>ca_management.php">
        ...
        <li class="nav-item <?php echo isActive('holidays', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>holidays.php">
        ...
        <li class="nav-item <?php echo isActive('payroll', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>payroll.php">
        ...
        <div class="sidebar-heading">System & Reports</div>

        <li class="nav-item <?php echo isActive('reports', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Reports">
        ...
        <li class="nav-item <?php echo isActive('policies', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Company Policies">
        ...
        <li class="nav-item <?php echo isActive('audit_logs', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Audit Logs">
    ...
    <?php if ($user_type == 2): ?>
        ...
        <li class="nav-item <?php echo isActive('payslips', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>payslips.php">
        ...
        <li class="nav-item <?php echo isActive('attendance', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>attendance.php">
                <i class="fas fa-fw fa-fingerprint"></i> <span>Attendance</span>
            </a>
        </li>

        <div class="sidebar-heading">Time Off</div>

        <li class="nav-item <?php echo isActive('file_overtime', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>file_overtime.php">
        ...
        <li class="nav-item <?php echo isActive('request_ca', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>request_ca.php">
        ...
        <li class="nav-item <?php echo isActive('request_leave', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>request_leave.php">
        ...
        <li class="nav-item <?php echo isActive('balances', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>balances.php">
                <i class="fas fa-fw fa-plus-minus"></i>
                <span>Balances</span>
            </a>
        </li>

        <div class="sidebar-heading">Organization</div>

        <li class="nav-item <?php echo isActive('directory', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Team%20Directory">
                <i class="fas fa-fw fa-users"></i>
        ...
        <li class="nav-item <?php echo isActive('documents', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Docs%20%26%20Policies">
        ...
        <li class="nav-item <?php echo isActive('help', $current_page); ?>">
            <a class="nav-link" href="<?php echo $base_link; ?>coming_soon.php?feature=Help%20%26%20Support">
