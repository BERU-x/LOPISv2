                ...
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="text-label text-uppercase text-xs font-weight-bold text-gray-600">Last
                                    Clock-In</div>
                                <div class="text-value h5 mb-0 font-weight-bold text-gray-800" id="card-clock-in">--:--
                                </div>
                            </div>
                        </div>
                        <div class="mt-3 mb-0 text-muted text-xs">
                            <span class="font-weight-bold" id="card-clock-status">--</span> status
                            <a href="attendance.php" class="text-decoration-none text-muted ms-2 float-end">Details
                                &rarr;</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="text-label text-uppercase text-xs font-weight-bold text-gray-600">OT
                                    Requests</div>
                        ...
                        <div class="mt-3 mb-0 text-muted text-xs">
                            Total: <span class="text-teal font-weight-bold"><span id="card-ot-hours">0.0</span>
                                hrs</span> pending
                            <a href="file_overtime.php" class="text-decoration-none text-muted ms-2 float-end">View
                                &rarr;</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="text-label text-uppercase text-xs font-weight-bold text-gray-600">Total
                                    Balance</div>
                                <div class="text-value h5 mb-0 font-weight-bold text-gray-800" id="card-loan-balance">
                                    ₱0.00</div>
                            </div>
                        </div>
                        <div class="mt-3 mb-0 text-muted text-xs">
                            Status: <span class="text-teal font-weight-bold" id="card-loan-status">Active</span>
                            <a href="balances.php" class="text-decoration-none text-muted ms-2 float-end">View
                                &rarr;</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="text-label text-uppercase text-xs font-weight-bold text-gray-600">Pending
                                    Leave</div>
                                <div class="text-value h5 mb-0 font-weight-bold text-gray-800">
                        ...
                        <div class="mt-3 mb-0 text-muted text-xs">
                            <span class="text-teal font-weight-bold"><span id="card-leave-days">0.0</span> days</span>
                            pending
                            <a href="request_leave.php" class="text-decoration-none text-muted ms-2 float-end">View
                                &rarr;</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-5 mb-4">
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header bg-transparent border-0 pb-0">
                        <h6 class="m-0 font-weight-bold text-gray-700">Leave Credits</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-transparent border-0 pb-0">
                        <h6 class="m-0 font-weight-bold text-gray-700">Quick Actions</h6>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-6">
                                <a href="payslips.php"
                                    class="btn btn-outline-light w-100 p-3 border-0 bg-soft-teal text-teal"
                                    style="border-radius: 1rem;">
                                    <i class="fas fa-file-invoice-dollar fa-lg mb-1"></i><br><span
                                        class="small font-weight-bold">Payslip</span>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="attendance.php"
                                    class="btn btn-outline-light w-100 p-3 border-0 bg-soft-teal text-teal"
                                    style="border-radius: 1rem;">
                                    <i class="fas fa-clock fa-lg mb-1"></i><br><span
                                        class="small font-weight-bold">DTR</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-transparent border-0">
                        <h6 class="m-0 font-weight-bold text-gray-700">Upcoming Holidays</h6>
                    </div>
