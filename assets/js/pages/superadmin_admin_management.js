...
function openModal(id = null) {
    ...
    if(id) {
        ...
        $('#password').attr('required', 'required').attr('placeholder', 'Default: Admin@123');
    }
    ...
    if (id) {
        ...
        $.ajax({
            // ⭐ UPDATED PATH
            url: '../api/superadmin/admin_management_action.php', 
            type: 'POST',
...
$(document).ready(function() {
    ...
    // Note: Use parent selector if #refreshIcon is an <i> tag inside a button/link
